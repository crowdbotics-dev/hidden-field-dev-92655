"""
Django settings for hidden_field_dev_92655 project.
...
ROOT_URLCONF = 'hidden_field_dev_92655.urls'
...
WSGI_APPLICATION = 'hidden_field_dev_92655.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hidden_field_dev_92655 API",
    "DESCRIPTION": "API documentation for hidden_field_dev_92655 App",
    "VERSION": "v1",
}
